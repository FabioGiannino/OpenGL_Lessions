...
RandomTextureDraw::RandomTextureDraw()
{
    ...
    RandomTextureID = new OpenGL_Texture(300, 300, 4);
    
    
    //Smile
    RandomTextureID->Bind(GL_TEXTURE0);
...
{   
    ...
    delete RandomTextureID;
    delete Program;
}

void RandomTextureDraw::Update(float InDeltaTime)
{
